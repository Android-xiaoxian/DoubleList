...
import com.fsx.doublelist.bean.Cityinfo;
import com.fsx.doublelist.utils.JSONParser;
import com.fsx.doublelist.utils.ReadFileUtil;
 ...
 * on 2019/2/14 0014
 */
public class DistinctPickerActivity extends AppCompatActivity {
...
//        }
        ...
        intent.putExtra("result", selected_province_text.getText().toString()
                + selected_city_text.getText().toString()
